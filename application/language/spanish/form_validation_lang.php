...
$lang['required']						= "El <strong>%s</strong> es obligatorio.";
$lang['isset']							= "El campo %s debe contener un valor.";
$lang['valid_email']					= "El campo <strong>%s</strong> debe contener una direccion de email correcta.";
...
$lang['v_email']						= "Introduce tu <strong>%s</strong> electrónico.";
$lang['v_pass']							= "Introduce tu <strong>%s</strong>.";
$lang['v_select']						= "Debe indicar alguna opción en el campo </strong>%s</strong>.";
$lang['v_texto']						= "El <strong>%s</strong> sólo debe contener caracteres alfabeticos";
